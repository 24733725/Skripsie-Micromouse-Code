...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(Motor_Enc_1A_GPIO_Port, Motor_Enc_1A_Pin);

    HAL_GPIO_DeInit(Motor_Enc_1B_GPIO_Port, Motor_Enc_1B_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Motor_Enc_2A_Pin|Motor_Enc_2B_Pin);
